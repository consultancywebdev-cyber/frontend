    ...
    <AdminLayout>
      <div className="p-6 lg:p-8">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-foreground mb-2">Study Destinations</h1>
            <p className="text-muted-foreground">Manage study abroad destinations</p>
          </div>
          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="max-w-2xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <Label htmlFor="universityCount">University Count</Label>
              ...
              <Card key={id || item.name} className="overflow-hidden">
                ...
                <div className="p-4">
                  ...
                  <div className="text-sm text-primary mb-3">
                    {item.universityCount} {item.universityCount === 1 ? "University" : "Universities"}
                  </div>
