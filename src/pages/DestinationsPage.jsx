          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl">
              ...
              <p className="text-lg lg:text-xl text-muted-foreground">
                ...
                around the globe. From vibrant cities to renowned academic hubs,
                find the perfect place to pursue your dreams.
              </p>
            </div>
          </div>
        </section>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-6">
                        ...
                        {country && (
                          <p className="text-sm text-white/90 mb-3">{country}</p>
                        )}
